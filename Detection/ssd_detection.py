...
from Risk_def import calc_1, calc_2
...
class DetectionNode(Node):
    ...
    def detect_callback(self, data):
        ...
        with torch.no_grad():
            pred, num_car, num_bus, num_truck, num_motor = self.net(images)[0] ## SSD 모델의 성능 확인
        ...
        risk, casual = calc_1(num_car, num_bus, num_truck, num_motor)
        cv2.putText(cv_image, "RISK(%) : "+risk+" / Casualty : "+casual)
